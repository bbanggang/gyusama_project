...
```
**결과**:
![image_buildx](https://github.com/user-attachments/assets/c816b045-d811-4fe6-aeb5-614450d047dd)
`gyusama-builder`가 현재 활성 빌더(`*`)로 amd64 + arm64 지원 확인

### 확인 2 — x86_64 + ARM64 동시 빌드 성공
![build_success](https://github.com/user-attachments/assets/0ca29556-fcc1-4268-a5ce-6509657f05e0)
...
- ARM64용 `onnxruntime`은 pip wheel이 제공되지만 QEMU 에뮬레이션 환경에서는 매우 느리다.
